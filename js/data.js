 ...
 *
 * Every js/ file is an IIFE ("immediately invoked function expression"):
 * it runs once, keeps its internals private, and exposes only what it
 * returns onto the shared window.RetroTerminal namespace. That is the whole
 * "module system" here — no bundler, no imports, just script order.
 * ========================================================================== */
(function (NS) {
  'use strict';
  ...
  NS.data = { USER: USER, MENU: MENU, REPORTS: REPORTS };
