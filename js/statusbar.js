  ...
  class StatusBar {
    ...
    constructor(el, store, user, menu) {
      ...
      this.intervalId = setInterval(function () {
        if (self.clockEl) self.clockEl.textContent = NS.helpers.formatClock(new Date());
      }, 1000);
    }
    ...
    render() {
      ...
      var node = selectedId ? NS.helpers.findNode(this.menu, selectedId) : null;
      ...
      this.clockEl.textContent = NS.helpers.formatClock(new Date());
